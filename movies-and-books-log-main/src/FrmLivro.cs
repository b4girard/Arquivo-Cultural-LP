    ...
    public partial class FrmLivro : Form
    {
        ...
        private void CarregarGrid()
        {
            using (MySqlConnection bdConn = new MySqlConnection(StringConexao()))
            {
                ...
                {
                    bdConn.Open();
                    string sql = @"SELECT ID_Livro, ISBN, Titulo, Autor, Idioma, Editora, N_Paginas, Capa
        ...
        private void Gravar()
        {
            ...
            using (bdCon = new MySqlConnection(StringConexao()))
            {
                try
                {
                    ...
                    // Pastas de imagens
                    string pastaSugestao = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..\\..\\banco de dados\\Imagens_SLivro");
                    ...
                    string sqlInsert = @"INSERT INTO livro (ISBN, Titulo, Autor, Idioma, Editora, N_Paginas, Capa)
            ...
            using (OpenFileDialog ofd = new OpenFileDialog())
            {
                ...
                if (ofd.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        caminhoImagemCompleto = nomeArquivo; // atualiza variável
                    }
                    catch (Exception ex)
                    {
        ...
        private void btnSelecionar_Click(object sender, EventArgs e)
        {
            ...
            {
                string caminhoCapa = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..\\..\\banco de dados\\Imagens_Livro",
                                                  nomeCapa);
