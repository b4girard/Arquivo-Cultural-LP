...
using Trabalho_Programacao.user.reviewLivros.Jantar_Secreto;

namespace Trabalho_Programacao.Usuario.Avaliacoes_Livros
{
    public partial class FrmVerJantarSecreto : Form
    {
        ...
        public FrmVerJantarSecreto(int livroID, int usuarioID)
        {
            InitializeComponent();
        ...
        {
            var avaliar = new FrmAvaliacaoJantarSecreto(livro_ID, usuario_ID);
            avaliar.Show();
            this.Hide();
        }
