    ...
    public partial class FrmFilme : Form
    {
            ...
            using (bdCon = new MySqlConnection(StringConexao()))
            {
                try
                {
                    ...
                    string sqlInsert = @"INSERT INTO filme 
                        ...
                        VALUES (@IMDb_ID, @Titulo, @Diretor, @Descricao, @Idioma_original, @Ano_de_lancamento, @Poster)";
        ...
        private void CarregarGrid()
        {
            using (MySqlConnection bdConn = new MySqlConnection(StringConexao()))
            {
                ...
                {
                    bdConn.Open();
                    string sql = @"SELECT ID_filme, IMDb_ID, Titulo, Diretor, Descricao, Idioma_original, 
        ...
        private void btnSelecionar_Click(object sender, EventArgs e)
        {
            ...
            descricao.Text = dataGridView1.CurrentRow.Cells["descricao"].Value?.ToString();
